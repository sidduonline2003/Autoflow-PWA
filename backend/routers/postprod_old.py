    ...
    if 'intakeSummary' not in data and 'intake_summary' not in data:
        try:
            ...
            if event_doc.exists:
                ...
                computed_summary = _compute_intake_summary(event_data)
                
                if computed_summary:
                    data['intakeSummary'] = computed_summary
                    # Save back to Firestore
                    job_document.update({'intakeSummary': computed_summary, 'updatedAt': datetime.utcnow()})
